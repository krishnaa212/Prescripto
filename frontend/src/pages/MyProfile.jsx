...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    name: "Krishna Didwania",
    image: assets.profile_pic,
    email: "krishnadidwania17@gmail.com",
    phone: "91+ 8910476212",
    address: {
      line1: "Jadavpur University",
      line2: "Jadavpur,Kolkata - 700032",
    },
    gender: "Male",
    dob: "26 November,2003"
  })
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
      ...
      <div className='mt-10'>
        ...
        {isEdit
          ? <button 
          onClick={() => setIsEdit(false)}className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'>Save information</button>
